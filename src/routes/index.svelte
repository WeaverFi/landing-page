...
<section id="header">
	<div class="content">
		...
		<a href="{appLink}"><button>Go to App</button></a>
	</div>
...
<section id="highlights">
	...
	<div class="privacy">
		<div class="content">
			...
			<span>This is not Web2. Your data is maintained locally on your browser and there is no intrusive ads, trackers, or any database collecting user data.</span>
		</div>
		<img src="" alt="Privacy">
	</div>
	<div class="devices">
...
<section id="contributors">
	...
	<div class="content">
		...
		<div class="list">
			...
			<a href="{sdkLink}"><button>Contribute</button></a>
			...
			<a href="{discordLink}"><button>Join the chat</button></a>
		</div>
	</div>
</section>
